...
public class ModulesGUI extends JFrame {
    ...
    public ModulesGUI() {
        ...
        // --- Table Setup ---
        String[] columns = {"Code", "Name", "Assmnt 1", "Assmnt 2", "Assmnt 3", "Location", "Lecturer", "Students"};
    ...
    private void refreshTable() {
        ...
        for (TextFileUtils.Module m : TextFileUtils.getAllModules()) {
            tableModel.addRow(new Object[]{m.code, m.name, m.a1, m.a2, m.a3, m.loc, m.lec, m.stu});
        }
    }
    ...
    private void showModuleDialog(TextFileUtils.Module existing) {
        ...
        JTextField tStu = new JTextField(existing != null ? existing.stu : "NULL");
        ...
        d.add(new JLabel("Students:")); d.add(tStu);
        d.add(btnSave);
        ...
        btnSave.addActionListener(ev -> {
            ...
            TextFileUtils.Module newMod = new TextFileUtils.Module(
                    ...
                    tA3.getText().trim(), locInput, tLec.getText().trim(), tStu.getText().trim()
            );
